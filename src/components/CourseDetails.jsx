...
const CourseDetails = () => {
  const arr = [
    ...
    },
    {
      ...
      description:
        "Master common data structures and algorithms used in technical interviews.",
      enrollmentStatus: "Open",
      duration: "10 weeks",
      progress: 30,
    ...
    },
    {
      ...
      description:
        "Learn Python and its libraries for data analysis, visualization, and machine learning.",
      enrollmentStatus: "Open",
      duration: "8 weeks",
      progress: 50,
  ...
  const course_detail = arr.filter((course) => course.id == courseId);
  ...
  return (
    ...
    <div className="course-details">
      <p><strong>Course Id : {course_detail[0].description}</strong></p>
      <p><strong>Course Name : {course_detail[0].name}</strong></p>
      <p><strong>Course Instructor : {course_detail[0].instructor}</strong></p>
      <p><strong>Course Description : {course_detail[0].description}</strong></p>
      <p><strong> Course Enrollment Status : {course_detail[0].enrollmentStatus}</strong></p>
      <p><strong> Course Duration : {course_detail[0].duration} </strong></p>
      <p><strong> Course Progress : {course_detail[0].progress}%</strong></p>
      <p><strong> Course Schedule : {course_detail[0].schedule}</strong></p>
      <p><strong> Course Location : {course_detail[0].location}</strong></p>
      <p><strong> Course Prerequisites : {course_detail[0].prerequisites}</strong></p>
      <ul>
        {course_detail[0].syllabus.map((item, index) => (
