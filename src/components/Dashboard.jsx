...
const Dashboard = () => {
  const arr = [
    ...
    },
    {
      ...
      description:
        "A comprehensive guide to building fullstack applications using React, Node.js, and MongoDB.",
  ...
  const handleCheckboxChange = (id) => {
    setCourses((prevCourses) =>
      prevCourses.map((course) =>
        course.id === id ? { ...course, progress: "100", enrollmentStatus : "Completed" } : course
      )
    );
  };
  ...
  const enrolledCourses2 = courses.filter(
